...
from backend.models.beauty_model import AvatarScorer
from backend.comment_template import COMMENTS
...
try:
    logger.info("開始初始化模型")
    model_path = os.path.join("backend", "models", "best_model.pth")
